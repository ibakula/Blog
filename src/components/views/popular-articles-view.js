    ...
    <>
      ...
      <Row>
        <Card border="light">
          ...
          <Card.Body>
            <Card.Title class={style.titleBoundaries}>Some long title, veeeeeeeeery loong title</Card.Title>
            <Card.Text class={style.textBoundaries}>Added some text to see the results, but decided to make the text extremly long so I could see where do I want it to stop and I find text size extremly important. Etcetcetc</Card.Text>
